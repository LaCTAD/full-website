  ...
  $translateProvider.translations('en', {
    ...
    PAGES: {
      ...
      CITATION: {
        ...
        TEXT1: '<p><b>We kindly ask our customers to cite LaCTAD in scientific papers that include our services, in order to help LaCTAD to continue to have public financing, allowing the constant update of our equipment and technical platforms.</b></p><p>Below, we provide a suggestion of acknowledgement to be included in scientific papers or posters. The text could be modified, depending on the context of each customer.</p>',
        TEXT2: '<h4>For articles:</h4><p>We suggest the following model:</p><p>“We thank the staff of the XXX (Cell Biology/ Genomics/ Proteomics/ Bioinformatics) section of the Life Sciences Core Facility (LaCTAD), part of the University of Campinas (UNICAMP), for their contributions to YYY (confocal microscopy/ sequencing/ mass spectrometry/ bioinformatics analysis, etc) ”</p>',
        TEXT3: '<h4>For posters:</h4><p>We suggest adding LaCTAD logo in the poster. A high-quality archive of our logo can be downloaded here.</p><p>Description of the equipment used during the services provided by LaCTAD can be found at “Equipment” section. If you need specific help, please contact our specialist team for the contracted service.</p>',
      },
      MANAGEMENT: {

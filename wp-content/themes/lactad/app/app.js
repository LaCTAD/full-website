  ...
  .translations('br', {
    ...
    PAGES: {
      TERMS: {
        ...
        "<p>Por questões de segurança, o LaCTAD manterá uma cópia dos dados do pesquisador, a qual ficará armazenada por um prazo máximo de 1 mês, contados a partir da data de entrega dos resultados. Após este prazo, os dados serão descartados definitivamente da base de dados do LaCTAD sem aviso prévio.</p>" +
      ...
      SERVICES: {
        ...
        BUTTON_REQUEST2: 'Solicitar Orçamento',
